...
<section class="row my-3">
      <section class="col-12">
            <form method="post" action="<?= $this->url('/admin/post/update/'. $post['id']) ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="published_at_view" autocomplete="off" required autofocus>
                  </div>
